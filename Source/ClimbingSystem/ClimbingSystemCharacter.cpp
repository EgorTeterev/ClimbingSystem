...
AClimbingSystemCharacter::AClimbingSystemCharacter(const FObjectInitializer& ObjInitializer)
	:Super(ObjInitializer.SetDefaultSubobjectClass<UCustomMovementComponent>(ACharacter::CharacterMovementComponentName))
{
	...
	WarpingComponent = CreateDefaultSubobject<UMotionWarpingComponent>(TEXT("MotionWarping"));
